...
import { createSchengenPackageApi } from "../../../api/schengenPackage";
...
const SchengenForm = ({ onSuccess }) => {
  ...
  const onFinish = async (values) => {
    setLoading(true);
    try {
      await createSchengenPackageApi(values);

      message.success("Schengen package created successfully!");
      if (onSuccess) {
        onSuccess(); 
      }
      form.resetFields();
